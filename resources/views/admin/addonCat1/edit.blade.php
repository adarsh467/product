...
@section('title', 'Addon | Category 1 | Edit')
    ...
    <div class="content-wrapper view-edit-user view-edit-banner view-scratch-card">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="fas fa-edit"></i> Edit Addon Cat 1 Product</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Edit Addon Cat 1 Product</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="active tab-pane" id="settings">
                                        <form id="quickForm" class="form-horizontal" method="post" action="{{ route('addon.cat1.edit', ['proId' => $proId, 'id' => Crypt::encryptString($addonCatOne->id)]) }}">
                                            @csrf
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <label for="inputName" class="col-sm-2 col-form-label required">{{ __('Name') }}</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="inputName" name="name" value="{{ old('name') ? old('name') : $addonCatOne->name }}" placeholder="Name">
                                                        @error('name')
                                                ...
                                                <div class="form-group row status">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="checkbox" name="status" class="form-control @error('status') is-invalid @enderror" id="inputStatus" {{ old('status') ? 'checked' : ($addonCatOne->status == 1 ? 'checked' : '') }} 
