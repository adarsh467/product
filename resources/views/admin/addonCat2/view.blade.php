    ...
    <div class="content-wrapper view-user">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="fas fa-eye"></i> View Addon Cat 2 Product</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">View Addon Cat 2 Product</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label for="inputTitle" class="col-sm-4 col-form-label">Name:</label>
                                                    <div class="form-container col-sm-8 p-2"> {{ $addonCatTwo->name }}</div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputTitle" class="col-sm-4 col-form-label">Price:</label>
                                                    <div class="form-container col-sm-8 p-2"> @money($addonCatTwo->price)</div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
