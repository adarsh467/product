...
@section('title', 'Addon | Category 2 | Add')
	...
	<div class="content-wrapper">
		...
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0"><i class="fas fa-store"></i><i class="icon-two fas fa-plus"></i> <span>Add Addon Cat 2 Product</span></h1>
					</div>
					<!-- /.col -->
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							...
							<li class="breadcrumb-item active">Add Addon Cat 2 Product</li>
						</ol>
					</div>
					<!-- /.col -->
				</div>
				...
				<div class="row">
                    ...
                    <div class="offset-2 col-md-8 col-md-offset-2">
                        ...
                        <div class="card card-info">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="quickForm" action="{{ route('addon.cat2.add', ['proId' => $proId, 'cat1Id' => $addonId]) }}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
